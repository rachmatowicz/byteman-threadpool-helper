...
public class JGroupsPeriodicHelper extends Helper
{
    /**
    ...
    public JGroupsPeriodicHelper(Rule rule) {
        super(rule);
        shutDown = false;
    }
    ...
    {
        if (theHelper == null) {
            theHelper = new JGroupsPeriodicHelper(null);
            theHelper.start();
        }
    }
    ...
    private void start()
    {
        theHelperThread = new JGroupsPeriodicHelperThread();
    ...
    private static JGroupsPeriodicHelper theHelper = null;

    /**
     * handle on the current helper thread
     */

    private static JGroupsPeriodicHelperThread theHelperThread = null;
    ...
    private class JGroupsPeriodicHelperThread extends Thread
    {
        private long periodMilliSecs;

        public JGroupsPeriodicHelperThread()
        {
            super("JGroups Periodic Helper Thread");
        }
