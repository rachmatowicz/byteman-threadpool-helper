...
public class InfinispanPeriodicHelper extends Helper
{
    /**
    ...
    public InfinispanPeriodicHelper(Rule rule) {
        super(rule);
        shutDown = false;
    }
    ...
    {
        if (theHelper == null) {
            theHelper = new InfinispanPeriodicHelper(null);
            theHelper.start();
        }
    }
    ...
    private void start()
    {
        theHelperThread = new InfinispanPeriodicHelperThread();
    ...
    private static InfinispanPeriodicHelper theHelper = null;

    /**
     * handle on the current helper thread
     */

    private static InfinispanPeriodicHelperThread theHelperThread = null;
    ...
    private class InfinispanPeriodicHelperThread extends Thread
    {
        private long periodMilliSecs;

        public InfinispanPeriodicHelperThread()
        {
            super("Infinispan Periodic Helper Thread");
        }
